...
## 3.Multi-Dimensional Gradient Method
  - **Introduction**
    ...
    Griewank|0.1,0.1|0.000,0.001|4|0.5,0.5|-0.001,0.001|4|1.1,1.2|0.000,-0.001|5|
    Ackley|
    Booths|
    Michalewicz|
    Rastrigin|0.1, -0.1|-0.995,0.995|2|0.0,-0.0|-1.3e-05,-1.3e-05|4|-0.2, -0.2|-0.995;-0.995|2|
    Spring_sys|
